...
namespace MoSeqAcquire.Views.Converters
{
    ...
    public class PackIconImageSourceConverter : MarkupExtension, IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (value is PackIconKind)
                return new PackIconKindImageSourceConverter { Thickness = Thickness }.Convert(value, targetType, parameter, culture);
    ...
    public class PackIconKindImageSourceConverter : PackIconImageSourceConverterBase<PackIconKind>
    {
        protected override ImageSource CreateImageSource(object value, Brush foregroundBrush, double penThickness)
        {
            var packIcon = new PackIcon { Kind = (PackIconKind)value };
